...
const DHelp = ({navigation}) => {
  return (
    <Layout style={styles.container}>
      <Layout style={styles.Arrow}>
        <Icon onPress={() => navigation.navigate('DSetting')} style={styles.arrow} fill="#0075A9" name="arrow-back" />
      </Layout>
      <Layout style={{marginTop:40,marginHorizontal:30}}>
      <Text style={styles.Heading}>Contact Us for Enquiries/Grievances – </Text>
      <TouchableOpacity onPress={() => Linking.openURL('mailto:https://mail.google.com/mail/?view=cm&fs=1&to=vigilanceai.2022@gmail.com')}>
      <Text style={styles.text}>Mail us at:  vigilanceai.com </Text>
      </TouchableOpacity>
